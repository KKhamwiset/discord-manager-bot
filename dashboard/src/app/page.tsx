      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="mt-12 grid grid-cols-2 gap-3">
          <div className="p-4 bg-base-100 border border-base-300 rounded-lg text-center">
            <span className="text-xl"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg></span>
          ...
          <div className="p-4 bg-base-100 border border-base-300 rounded-lg text-center">
            <span className="text-xl"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg></span>
