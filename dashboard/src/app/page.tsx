...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(244,114,182,0.22),transparent_30%),radial-gradient(circle_at_85%_15%,rgba(251,207,232,0.45),transparent_24%),linear-gradient(180deg,#ffffff_0%,#fff7fb_48%,#ffeef6_100%)] text-base-content">
      <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-pink-400 via-primary to-rose-400" />
      <div className="pointer-events-none absolute -left-24 top-20 h-72 w-72 rounded-full bg-pink-200/35 blur-3xl" />
      <div className="pointer-events-none absolute -right-20 bottom-20 h-80 w-80 rounded-full bg-rose-200/45 blur-3xl" />

      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col px-5 py-6 sm:px-8 lg:px-10">
        <header className="flex items-center justify-between rounded-full border border-pink-100/80 bg-white/82 px-4 py-3 shadow-sm backdrop-blur-xl sm:px-5">
          ...
          <div className="hidden items-center gap-2 rounded-full border border-pink-100 bg-pink-50 px-3 py-1.5 text-xs font-bold text-pink-800 sm:flex">
        ...
        <section className="grid flex-1 items-center gap-10 py-12 lg:grid-cols-[1.05fr_0.95fr] lg:py-16">
          <div className="max-w-3xl">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-pink-200 bg-white px-4 py-2 text-sm font-extrabold text-pink-800 shadow-sm">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <div className="rounded-2xl border border-pink-100 bg-white px-5 py-3 shadow-sm">
                <p className="text-xs font-bold uppercase tracking-[0.18em] text-pink-700">Managing</p>
          ...
          <div className="relative">
            <div className="absolute -inset-4 rounded-[2.25rem] bg-gradient-to-br from-pink-200/70 via-white to-rose-200/70 blur-2xl" />
            <div className="relative overflow-hidden rounded-[2rem] border border-pink-100 bg-white p-5 shadow-[0_24px_90px_rgba(196,26,122,0.16)] sm:p-6">
              <div className="rounded-[1.5rem] bg-gradient-to-br from-pink-50 via-white to-rose-50 p-5 ring-1 ring-pink-100">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-pink-700">Live preview</p>
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                  <div className="rounded-2xl border border-pink-100 bg-white p-4 shadow-sm">
                    ...
                    <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#7a3d5c]">Members</p>
                  </div>
                  <div className="rounded-2xl border border-pink-100 bg-white p-4 shadow-sm">
                    ...
                    <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#7a3d5c]">Region</p>
                  </div>
                </div>
              ...
              <div className="mt-4 grid gap-3">
                {featureCards.map((feature) => {
                  ...
                  return (
                    <div key={feature.title} className="flex items-center gap-3 rounded-2xl border border-pink-100 bg-white px-4 py-3 shadow-sm">
                      <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-pink-50 text-primary ring-1 ring-pink-100">
                        <Icon className="h-5 w-5" aria-hidden="true" />
                      </div>
                      <div>
                        <p className="text-sm font-extrabold text-[#2a1220]">{feature.title}</p>
                        <p className="text-xs font-medium text-[#7a3d5c]">{feature.description}</p>
                      </div>
                    </div>
                  );
                })}
